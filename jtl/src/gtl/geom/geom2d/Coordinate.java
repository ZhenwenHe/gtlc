 ...
 */
public abstract class Coordinate implements Cloneable, Serializable,Comparable<Coordinate>{
    /**
     ...
     */
    public abstract void setCoordinate(Coordinate other) ;
     ...
     */
    public abstract boolean equals2D(Coordinate other);
     ...
     */
    public abstract boolean equals2D(Coordinate c, double tolerance);
    /**
     ...
     */
    public abstract boolean equals3D(Coordinate other) ;
     ...
     */
    public abstract boolean equalInZ(Coordinate c, double tolerance);
    /**
     ...
     */
    public abstract double distance3D(Coordinate c);
     ...
     */
    @Override
    public abstract int compareTo(Coordinate other)  ;
