...
#ifdef _MSC_VER
// The standards-conforming two-digit exponent mode is now the default after VC2015
//and the non-conforming, previously-default, three-digit exponent format is no longer supported.
#if(_MSC_VER<1900)
