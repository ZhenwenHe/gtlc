...
//      k = (int) (x1 / x2);
    ...
    public static int orientationIndex(Vertex p1, Vertex p2, Vertex q)
    {
         ...
         *
         * Vertex p0 = new Vertex(219.3649559090992, 140.84159161824724);
         * Vertex p1 = new Vertex(168.9018919682399, -5.713787599646864);
         *
         * Vertex p = new Vertex(186.80814046338352, 46.28973405831556); int
