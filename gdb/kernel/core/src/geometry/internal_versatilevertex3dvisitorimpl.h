...
begin_gtl_namespace
begin_gdb_namespace 
class  VersatileVertex3dVisitorImpl :public VersatileVertex3dVisitor {
public:
	virtual double & x(long i);
	virtual double & y(long i);
	virtual double & z(long i);
	virtual double & nx(long i);
	virtual double & ny(long i);
	virtual double & nz(long i);
	virtual double & u(long i);
	virtual double & v(long i);
