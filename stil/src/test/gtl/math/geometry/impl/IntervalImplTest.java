...
public class IntervalImplTest extends TestCase {
    ...
    public void testEquals() throws Exception {
        ...
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,10,20);
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10.01,20);
        Interval i5 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20.001);
    ...
    public void testSetBounds() throws Exception {
        ...
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10.01,20);
        Interval i5 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20.001);
        Interval i6 = IndexSuits.createInterval(IntervalType.IT_CLOSED,100,202.001);
    ...
    public void testIntersects() throws Exception {
        ...
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,30,40);
        assertFalse(i1.intersects(i2));

        Interval i3 = IndexSuits.createInterval(IntervalType.IT_CLOSED,-10,9);
        assertFalse(i1.intersects(i2));

        Interval i4 = IndexSuits.createInterval(IntervalType.IT_CLOSED,-10,10);
        assertTrue(i1.intersects(i4));
        Interval i5= IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,-10,10);
        assertFalse(i1.intersects(i5));
        Interval i6= IndexSuits.createInterval(IntervalType.IT_LEFTOPEN,-10,10);
        assertTrue(i1.intersects(i6));
        Interval i7= IndexSuits.createInterval(IntervalType.IT_OPEN,-10,10);
        assertFalse(i1.intersects(i7));


        Interval i8 = IndexSuits.createInterval(IntervalType.IT_CLOSED,-10,15);
        assertTrue(i1.intersects(i8));
        Interval i9= IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,-10,20);
        assertTrue(i1.intersects(i9));
        Interval i10= IndexSuits.createInterval(IntervalType.IT_LEFTOPEN,-10,40);
        assertTrue(i1.intersects(i10));


        Interval i11 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,15);
        assertTrue(i1.intersects(i11));
        Interval i12= IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,10,20);
        assertTrue(i1.intersects(i12));
        Interval i13= IndexSuits.createInterval(IntervalType.IT_LEFTOPEN,10,40);
        assertTrue(i1.intersects(i13));

        Interval i14 = IndexSuits.createInterval(IntervalType.IT_CLOSED,15,18);
        assertTrue(i1.intersects(i14));
        Interval i15= IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,15,20);
        assertTrue(i1.intersects(i15));
        Interval i16= IndexSuits.createInterval(IntervalType.IT_LEFTOPEN,15,30);
        assertTrue(i1.intersects(i16));

        Interval i17 = IndexSuits.createInterval(IntervalType.IT_CLOSED,20,30);
        assertTrue(i1.intersects(i17));
        Interval i18= IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,20,30);
        assertTrue(i1.intersects(i18));
        Interval i19= IndexSuits.createInterval(IntervalType.IT_LEFTOPEN,20,30);
    ...
    public void testLowerClosed() throws Exception {
        ...
        i1 = IndexSuits.createInterval(IntervalType.IT_OPEN,10.0,20.0);
        assertFalse(i1.lowerClosed());
        i1 = IndexSuits.createInterval(IntervalType.IT_LEFTOPEN,10.0,20.0);
        assertFalse(i1.lowerClosed());
        i1 = IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,10.0,20.0);
        assertTrue(i1.lowerClosed());
    ...
    public void testClone() throws Exception {
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10.0,20.0);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10.0,20.0);
        assertTrue(i1.equals(i2));
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_RIGHTOPEN,10.0,20.0);
        assertFalse(i1.equals(i3));
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_CLOSED,-10.0,20.0);
        assertFalse(i1.equals(i4));
        Interval i5 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10.0,30.0);
        assertFalse(i1.equals(i5));
    }
    ...
    public void testWrite() throws Exception {
        ...
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_OPEN,30.0,40.0);
        ...
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_CLOSED,0,1);
        Interval i5 = IndexSuits.createInterval(IntervalType.IT_OPEN,0,1);
        Interval i6 = IndexSuits.createInterval(IntervalType.IT_OPEN,0,1);
    ...
    public void testStarts() throws Exception {
        ...
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,18);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_OPEN,10,18);
    ...
    public void testMeets() throws Exception {
        ...
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,20,30);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_OPEN,20,30);
    ...
    public void testFinishes() throws Exception {
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,15,20);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_OPEN,10,20);
    ...
    public void testBefore() throws Exception {
        ...
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,15,20);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_OPEN,-10,10);
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_OPEN,-10,9);
    ...
    public void testOverlaps() throws Exception {
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,15,30);
    ...
    public void testDuring() throws Exception {
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_OPEN,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,15,30);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_CLOSED,9,30);
    ...
    public void testCovers() throws Exception {
        Interval i1 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i4 = IndexSuits.createInterval(IntervalType.IT_CLOSED,10,20);
        Interval i2 = IndexSuits.createInterval(IntervalType.IT_CLOSED,15,30);
        Interval i3 = IndexSuits.createInterval(IntervalType.IT_CLOSED,9,30);
