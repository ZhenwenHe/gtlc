...
public class RTreeImpl implements RTree{
    ...
    public void reset(StorageManager storageManager,PropertySet propSet) {
        ...
        this.rootIdentifier = CommonSuits.createIdentifier(StorageManager.NEW_PAGE);
        this.headerIdentifier =CommonSuits.createIdentifier(StorageManager.NEW_PAGE);
    ...
    public void reset(StorageManager storageManager,
        ...
        if(indexIdentifier==null){//new
            ...
            RTreeExternalNodeImpl root =new RTreeExternalNodeImpl(this, CommonSuits.createIdentifier(-1L));
    ...
    public PropertySet getProperties() {
        PropertySet ps = CommonSuits.createPropertySet();//new PropertySetImpl();
    ...
    Identifier writeNode(Node n){
        try{
            ...
            Identifier page = CommonSuits.createIdentifier(-1L);
    ...
    Node readNode(Identifier page){
        try{
            ...
            if (nodeType == 1)
                n = new RTreeInternalNodeImpl(this, CommonSuits.createIdentifier(-1L), 0);
			else
                n = new RTreeExternalNodeImpl(this, CommonSuits.createIdentifier(-1L));
