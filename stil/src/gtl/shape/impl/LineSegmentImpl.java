...
class LineSegmentImpl implements LineSegment {
    ...
    public double getMinimumDistance(Point p) {
        ...
        if (this.endCoordinates[0] >= this.startCoordinates[0] - MathSuits.EPSILON &&
                this.endCoordinates[0] <= this.startCoordinates[0] + MathSuits.EPSILON)
            return Math.abs(p.getCoordinate(0) - this.startCoordinates[0]);

        if (this.endCoordinates[1] >= this.startCoordinates[1] - MathSuits.EPSILON &&
                this.endCoordinates[1] <= this.startCoordinates[1] + MathSuits.EPSILON)
    ...
    public double getAngleOfPerpendicularRay() {
        ...
        if (this.startCoordinates[0] >= this.endCoordinates[0] - MathSuits.EPSILON &&
                this.startCoordinates[0] <= this.endCoordinates[0] + MathSuits.EPSILON) return 0.0;

        if (this.startCoordinates[1] >= this.endCoordinates[1] - MathSuits.EPSILON &&
                this.startCoordinates[1] <= this.endCoordinates[1] + MathSuits.EPSILON) return MathSuits.M_PI_2;
