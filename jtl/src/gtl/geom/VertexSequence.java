 ...
 */
interface VertexSequence extends Serializable {
    ...
    /**
     * Expands the given {@link Envelope2D} to include the coordinates in the sequence.
     * Allows implementing classes to optimize access to coordinate values.
     *
     * @param env the envelope2D to expand
     * @return a ref to the expanded envelope2D
     */
    Envelope2D expandEnvelope(Envelope2D env);
