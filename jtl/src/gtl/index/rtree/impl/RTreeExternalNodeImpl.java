...
public class RTreeExternalNodeImpl extends RTreeNodeImpl{
    ...
    protected Node[] split(Entry e) {
        ...
        nodes[0] = (Node) new RTreeExternalNodeImpl(this.tree, CommonSuits.createIdentifier(-1L));
        nodes[1] = (Node) new RTreeExternalNodeImpl(this.tree, CommonSuits.createIdentifier(-1L));
